...
public class ListaStruttureElement {
    ...
    public ListaStruttureElement(int codiceSede, String nomeSede, String indirizzoSede, String cap, String telefono, String email, String orariApertura) {
